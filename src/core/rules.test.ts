...
import { suggestCanonical, type Config } from './rules.js'

test('suggestCanonical - text sizes', async (t) => {
  ...
  await t.test('text-[11px] without custom tokens maps to text-2xs (custom)', () => {
  ...
  await t.test('text-[11px] with custom text tokens maps to custom token', () => {
...
test('suggestCanonical - spacing (divisible by 4)', async (t) => {
...
test('suggestCanonical - spacing with custom tokens', async (t) => {
...
test('suggestCanonical - rounded values', async (t) => {
...
test('suggestCanonical - non-arbitrary classes', async (t) => {
...
test('suggestCanonical - edge cases', async (t) => {
